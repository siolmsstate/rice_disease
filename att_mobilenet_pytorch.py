...
def attmobilenet(base_model=mobilenet, num_class=10):
    features = list(base_model.features.children())
    features[-1] = nn.Sequential(
        AugmentedConv(in_channels=320, out_channels=1280,
...
att_mobilenet = attmobilenet(base_model=mobilenet, num_class=10)